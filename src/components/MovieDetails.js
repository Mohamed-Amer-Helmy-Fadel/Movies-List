        ...
        <div>
            ...
            <Row className="justify-content-center">
                <Col
                    ...
                    <a href={movie.homepage} >  {/* i can put it in Link but  i have to rab NavBar in App.js with BrotherRouter// and the only bad thing in a href is that it make page reloading */}
                        <button
                            style={{ backgroundColor: "#b45b35", border: "none" }}
